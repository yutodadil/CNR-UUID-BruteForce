...
def brute():
#数値を取り込むよ!!
    global trynum, TotalSendedShare, TotalFailedReq, DebugMode, success, badnum, check, checked
#グラデの色を決めるよ!!
...
#Titleの設定
    os.system(f"title Bruter is Now Working. - BadTry {badnum} - Success {success} - Checking {check} - checked {checked} - All {trynum}")
#試行回数を1追加
    trynum += 1
#もしも間違っていたら
